...
function SheetOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      ...
      isDismissable
      className={cn(
        "fixed inset-0 z-50 bg-black/40 transition-opacity duration-200 data-entering:opacity-0 data-exiting:opacity-0 supports-backdrop-filter:backdrop-blur-md",
        className
      )}
      {...props}
    >
